<?php
    ...
    if (isset($_GET['total']) && ($_GET['total'] > 0) && (!empty($_SESSION['cart'])))
    {
        ...
        echo '<p class="info">Thanks for your order. Your Order Number is '.$order_id.'</p>';

        # Remove cart items.  
        $_SESSION['cart'] = NULL;
    }
    # Or display a message.
    else { echo '<p class="info">There are no items in your cart.</p>' ; }

    # Create navigation links.
    echo '<br><p><a href="shop.php">Shop</a> | <a href="forum.php">Forum</a> | <a href="index.php">Home</a> | <a href="logout.php">Logout</a></p>' ;
    echo '</section></main>';
